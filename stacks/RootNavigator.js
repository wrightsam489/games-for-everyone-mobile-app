...
function DrawerNavigator() {
  return (
    <Drawer.Navigator 
      screenOptions={{ headerShown: false, headerTitleAlign: 'center', drawerPosition: 'right' }}
      drawerContent={ props => { 
        return (
...
function GameStack({ navigation }) {
  ...
  return (
    <Stack.Navigator screenOptions={{ headerTitleAlign: 'center', headerRight: () => { return <IconButton onPress={() => { navigation.toggleDrawer() }} iconName='navicon' size={25} />} }}>
